...
public class LogMetaDataS3EventHandlerTest {
    ...
    @Test
    public void testLogMetaDataS3EventHandler() {
        LogMetaDataS3EventHandler handler = new LogMetaDataS3EventHandler(s3Client);
